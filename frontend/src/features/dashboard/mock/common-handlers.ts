  ...
  sections: [
    {
      ...
      body: 'This 3-bedroom house at 123 represents a solid investment opportunity in a growing market. The sample analysis indicates a current market value of $850,000 with strong confidence based on recent comparable sales and market conditions.',
    },
    {
      heading: 'Property Analysis:',
      body: 'The property demonstrates excellent location attributes with strong amenity access, transport connectivity, and school quality. The property size aligns well with market expectations for this type of dwelling.',
    },
  ],
  disclaimer:
...
const EXECUTIVE_SUMMARY_DATA: ExecutiveSummary = {
  ...
  paragraphs: [
    ...
    [
      {
        text: 'Based on a comprehensive analysis of eight comparable sales within a 1.5km radius completed between March and June 2026, the sample valuation model has derived an appraisal range of ',
      },
      {
  ...
  observationMessage:
    'The primary comparable — 12 Alexandra Ave, South Yarra (sold $1,510,000, June 2026, auction) — is the strongest anchor for this estimate given near-identical land size (412m²), matching bedroom and bathroom configuration, and proximity (0.4km). This sale carries a 28% weighting in the sample valuation model.',
}
